...
import com.example.mindmate.Models.Journal
import com.example.mindmate.Models.JournalViewModel
...
class JournalsCrudFragment : Fragment(), JournalsAdapter.JournalsClickListener, PopupMenu.OnMenuItemClickListener{
    ...
    private val updateJournal = registerForActivityResult(ActivityResultContracts
